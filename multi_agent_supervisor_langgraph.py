...
load_dotenv()
if not os.getenv("llama_key"):
    raise ValueError("llama_key not found in environment variables")
...
# LANGSMITH_PROJECT="multi_agent_langgraph"

#setup LangSmith
os.environ["LANGCHAIN_API_KEY"] = os.getenv("LangSmith")
os.environ["LANGCHAIN_TRACING_V2"] = "true"
os.environ["LANGCHAIN_PROJECT"] = "multi_agent_langgraph"
...
class Router(TypedDict):
    ...
    next: Literal["researcher", "coder ", "FINISH"] #options
